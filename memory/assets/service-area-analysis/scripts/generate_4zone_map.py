...
Archived generator. Outputs write to frontend/internal/ (CSV) and
memory/assets/service-area-analysis/maps/ (PNG). Requires ORS_API_KEY
only if regenerating isochrones.
"""
...
# Archive paths (repo-relative). Do not write into frontend/public/.
_REPO_ROOT = Path(__file__).resolve().parents[4]
_INTERNAL = _REPO_ROOT / "frontend" / "internal"
_MAPS = Path(__file__).resolve().parents[1] / "maps"
...
# Known DFW zip codes - comprehensive list including all that intersect service area
DFW_ZIP_CODES = [
    # Original list
    ...
    # NEW: Missing zip codes that intersect the service area (>5% overlap with Zone 4)
    "75009", "75094", "75126", "75134", "75137", "75141", "75146", "75154",
    "75172", "75180", "75203", "75210", "75215", "75216", "75217", "75223",
    "75224", "75227", "75232", "75233", "75237", "75241", "75249", "75253",
    "75261", "75270",
    "76005", "76020", "76060", "76065", "76071", "76078", "76102", "76103",
    "76104", "76105", "76106", "76107", "76108", "76109", "76110", "76111",
    "76112", "76114", "76115", "76116", "76119", "76123", "76126", "76127",
    "76129", "76131", "76132", "76133", "76134", "76135", "76140", "76164",
    "76179", "76203", "76249", "76258", "76259", "76266",
]

ZIP_TO_CITY = {
    "75001": "Addison", "75002": "Allen", "75006": "Carrollton", "75007": "Carrollton",
    "75009": "Celina", "75010": "Carrollton", "75013": "Allen", "75019": "Coppell", 
    "75022": "Flower Mound", "75023": "Plano", "75024": "Plano", "75025": "Plano", 
    "75028": "Flower Mound", "75032": "Rockwall", "75033": "Frisco", "75034": "Frisco", 
    "75035": "Frisco", "75036": "Frisco", "75038": "Irving", "75039": "Irving", 
    "75040": "Garland", "75041": "Garland", "75042": "Garland", "75043": "Garland", 
    "75044": "Garland", "75048": "Sachse", "75050": "Grand Prairie", "75051": "Grand Prairie",
    ...
    "75094": "Plano", "75098": "Wylie", "75104": "Cedar Hill", "75115": "DeSoto", 
    "75116": "Duncanville", "75126": "Forney", "75134": "Lancaster", "75137": "Duncanville",
    "75141": "Hutchins", "75146": "Lancaster", "75149": "Mesquite", "75150": "Mesquite", 
    "75154": "Red Oak", "75172": "Wilmer", "75180": "Balch Springs", "75181": "Mesquite", 
    "75182": "Sunnyvale", "75201": "Dallas", "75202": "Dallas", "75203": "Dallas",
    ...
    "76018": "Arlington", "76020": "Azle", "76021": "Bedford", "76022": "Bedford", 
    "76034": "Colleyville", "76039": "Euless", "76040": "Euless", "76051": "Grapevine", 
    "76052": "Haslet", "76053": "Hurst", "76054": "Hurst", "76060": "Kennedale",
    "76063": "Mansfield", "76065": "Midlothian", "76071": "Newark", "76078": "Rhome",
    "76092": "Southlake", "76102": "Fort Worth", "76103": "Fort Worth", "76104": "Fort Worth",
    ...
    "76114": "Fort Worth", "76115": "Fort Worth", "76116": "Fort Worth", "76117": "Haltom City",
    "76118": "Fort Worth", "76119": "Fort Worth", "76120": "Fort Worth", "76123": "Fort Worth",
    "76126": "Fort Worth", "76127": "Fort Worth", "76129": "Fort Worth", "76131": "Fort Worth",
    "76132": "Fort Worth", "76133": "Fort Worth", "76134": "Fort Worth", "76135": "Fort Worth",
    "76137": "Fort Worth", "76140": "Fort Worth", "76148": "North Richland Hills", 
    "76155": "Fort Worth", "76164": "Fort Worth", "76177": "Fort Worth", "76179": "Fort Worth",
    "76180": "North Richland Hills", "76182": "North Richland Hills",
    "76201": "Denton", "76203": "Denton", "76205": "Denton", "76207": "Denton", 
    "76208": "Denton", "76209": "Denton", "76210": "Denton", "76226": "Argyle", 
    "76227": "Aubrey", "76244": "Keller", "76247": "Justin", "76248": "Keller", 
    "76249": "Krum", "76258": "Pilot Point", "76259": "Ponder", "76262": "Roanoke",
    "76266": "Sanger",
}
...
def get_isochrones():
    ...
    if not ORS_API_KEY:
        raise SystemExit(
            "Set ORS_API_KEY (openrouteservice.org) to regenerate isochrones. "
            "The saved CSV/PNG in this archive do not need a key."
        )
    print("\n" + "="*60)
...
def main():
    ...
    # Save CSV
    csv_path = str(_INTERNAL / 'DFW_HVAC_Service_Area_4Zone.csv')
    out_df.to_csv(csv_path, index=False)
    print(f"\n✓ CSV saved to {csv_path}")
    
    # Step 5: Create map
    map_path = str(_MAPS / 'dfw_service_area_map_4zone.png')
