...
|---|---|---|---|
| AH1 | **June 2, 2026** (hard cutoff) | Bump `gitleaks/gitleaks-action@v2` → `@v3` in `.github/workflows/security.yml`. | **DONE Aug 24, 2026** — `@v3` shipped; closes Node-20 action warning before Sep 16, 2026 runner removal. |
...
- **Aug 24, 2026** — F12 + AH1: CI `setup-node` 20→24 (KPI/security/Lighthouse); `gitleaks-action@v3`. Fixes Monday KPI install failure (`@sanity/visual-editing` needs Node ≥22.12).
