  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outlineBlue:
          "border-2 border-electric-blue bg-transparent text-electric-blue shadow-xs hover:bg-electric-blue hover:text-white",
        secondary:
        ...
        // ============================================
        urgency:
          "bg-vivid-red text-white font-semibold shadow-sm hover:bg-vivid-red/90",
        primary:
          "bg-electric-blue text-white font-semibold shadow-sm hover:bg-prussian-blue",
        growth:
