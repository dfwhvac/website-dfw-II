...
const Header = ({ companyInfo = {} }) => {
  ...
  const residentialServices = [
    ...
    { name: 'Preventative Maintenance', path: '/services/residential/preventative-maintenance' },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <NavigationMenu className="hidden lg:flex">
            <NavigationMenuList>
              <NavigationMenuItem>
                <Link href="/" className="px-4 py-2 hover:text-electric-blue transition-colors">
                  Home
                </Link>
              </NavigationMenuItem>
              ...
              <NavigationMenuItem>
                <Link href="/about" className="px-4 py-2 hover:text-electric-blue transition-colors">
                  About
                </Link>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <Link href="/reviews" className="px-4 py-2 hover:text-electric-blue transition-colors">
                  Reviews
                </Link>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <Link href="/contact" className="px-4 py-2 hover:text-electric-blue transition-colors">
                  Contact
                </Link>
              </NavigationMenuItem>
            </NavigationMenuList>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-gray-200">
          <div className="container mx-auto px-4 py-4 space-y-4">
            <Link href="/" className="block py-2 text-gray-700 hover:text-electric-blue">
              Home
            </Link>
            ...
            <Link href="/about" className="block py-2 text-gray-700 hover:text-electric-blue">
              About
            </Link>
            <Link href="/reviews" className="block py-2 text-gray-700 hover:text-electric-blue">
              Reviews
            </Link>
            <Link href="/contact" className="block py-2 text-gray-700 hover:text-electric-blue">
              Contact
            </Link>
            ...
            <div className="pt-4 space-y-2">
              ...
              <Button className="w-full bg-electric-blue hover:bg-electric-blue text-white" asChild>
                <Link href="/book-service">Book Service</Link>
              </Button>
            </div>
          </div>
