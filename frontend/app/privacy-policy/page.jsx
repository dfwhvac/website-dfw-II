  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg prose-headings:text-[#003153] prose-a:text-[#00B8FF]">
            ...
            <p>We may also automatically collect limited technical information such as:</p>
            <ul>
              <li>IP address</li>
            ...
            <h2>Text Messaging and Communications</h2>
            <p>
            ...
            <h2>Financing and Payment Partners</h2>
            <p>
            ...
            <h2>Privacy Rights for Texas Residents</h2>
            <p>
