      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Information We Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Text Messaging and Communications</h2>
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Sharing of Information</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Financing and Payment Partners</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Cookies and Tracking Technologies</h2>
            <p className="text-gray-600 mb-6">
              Our website may use cookies and similar technologies to improve functionality and analyze website usage.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Data Security</h2>
            <p className="text-gray-600 mb-6">
              We take reasonable administrative, technical, and physical safeguards to protect your personal information.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Privacy Rights for Texas Residents</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Call Recording</h2>
            <p className="text-gray-600 mb-6">
              For quality assurance and training purposes, phone calls with DFW HVAC, LLC may be recorded.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Children&apos;s Privacy</h2>
            <p className="text-gray-600 mb-6">
              Our services are not directed to individuals under the age of 13.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Third-Party Links</h2>
            <p className="text-gray-600 mb-6">
              Our website may contain links to third-party websites. We are not responsible for their privacy practices.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Changes to This Policy</h2>
            <p className="text-gray-600 mb-6">
              We may update this Privacy Policy periodically.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">Contact Us</h2>
