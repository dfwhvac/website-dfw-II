  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-white">
            ...
            <a 
              ...
              className="flex items-center gap-2 bg-white text-prussian-blue px-6 py-2 rounded-full font-bold hover:bg-gray-100 transition-colors"
            >
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-prussian-blue mb-8 text-center">
              Select Your City
            </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {cities.map((city) => (
                  <Link
                    ...
                    className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-electric-blue hover:shadow-lg transition-all duration-300"
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-xl font-bold text-prussian-blue group-hover:text-electric-blue transition-colors">
                          {city.cityName}
                        </h3>
                      ...
                      <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-electric-blue transition-colors" />
                    </div>
                  </Link>
                ))}
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-prussian-blue mb-4">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-prussian-blue mb-8">
