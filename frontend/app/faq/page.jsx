...
const defaultFaqs = [
  ...
  { _id: 'rs1', category: 'residential-services', order: 1,
    ...
    answer: 'We offer comprehensive residential HVAC services including air conditioning repair, installation, and maintenance; heating system repair and installation; indoor air quality solutions; duct cleaning and sealing; thermostat installation; and 24/7 emergency repairs. We service all major brands and system types.' },
  ...
  { _id: 'rs3', category: 'residential-services', order: 3,
    ...
    answer: 'Yes, we offer 24/7 emergency HVAC repair services throughout the Dallas-Fort Worth area. When your AC fails on a hot Texas summer day or your heater stops working during a cold snap, call us anytime and we\'ll dispatch a technician as quickly as possible.' },
  ...
  { _id: 'c4', category: 'commercial', order: 4,
    ...
    answer: 'Yes, we offer customized maintenance agreements for commercial clients. These include scheduled preventive maintenance, priority emergency service, detailed documentation for your records, and discounted labor rates. Regular maintenance is critical for commercial systems.' },
  { _id: 'c5', category: 'commercial', order: 5,
    question: 'How quickly can you respond to commercial emergencies?',
    answer: 'We prioritize commercial emergency calls because we understand a failed HVAC system can mean lost revenue, uncomfortable customers, and employee productivity issues. We typically respond to commercial emergencies within 2-4 hours during business hours.' },
        ...
        <section className="bg-prussian-blue text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
              Our friendly team is here to help. Give us a call or schedule a free consultation.
            </p>
