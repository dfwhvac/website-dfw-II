...
import { shouldIncludeAnalyticsScripts } from '../lib/analytics'
...
export default async function RootLayout({ children }) {
  ...
  const includeAnalytics = shouldIncludeAnalyticsScripts()
  ...
  return (
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        />
        {/* Tier 1–2 analytics: @next/third-parties GA4 + lazyOnload Clarity (production only).
            Tier 3 widgets use hooks/useLazyScript.js. See ProductionAnalytics.jsx. */}
        {includeAnalytics ? <ProductionAnalytics /> : null}
