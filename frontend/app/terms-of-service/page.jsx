...
export async function generateMetadata() {
  // P1.6a title rewrite (Apr 23, 2026) — no change from existing. CSV row 11.
  return {
    title: 'Terms of Service | DFW HVAC',
    description: 'Terms of Service for DFW HVAC. Review the terms and conditions governing your use of our website and HVAC services.',
    alternates: {
...
export default async function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-prussian-blue to-electric-blue text-white py-16">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">1. Services</h2>
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">2. Estimates and Pricing</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">3. Scheduling and Appointments</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">4. Customer Responsibilities</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">9. Limitation of Liability</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">10. Website Use</h2>
            <p className="text-gray-600 mb-6">
              Website content is for general information only. Users agree not to misuse the website or submit false information.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">11. Third-Party Services</h2>
            <p className="text-gray-600 mb-6">
              We are not responsible for third-party providers or linked services.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">12. Communications</h2>
            <p className="text-gray-600 mb-6">
              Calls and communications may be recorded. By contacting us, you consent to receive service-related communications.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">13. Force Majeure</h2>
            <p className="text-gray-600 mb-6">
              We are not responsible for delays caused by events beyond our control.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">14. Governing Law</h2>
            <p className="text-gray-600 mb-6">
              These Terms are governed by Texas law. Disputes shall be resolved in the Dallas-Fort Worth area.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">15. Changes</h2>
            <p className="text-gray-600 mb-6">
              We may update these Terms periodically. Continued use indicates acceptance.
            </p>

            <h2 className="text-2xl font-bold text-prussian-blue mt-10 mb-4">16. Contact</h2>
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="font-semibold text-prussian-blue text-lg mb-4">DFW HVAC, LLC</p>
              <div className="space-y-2 text-gray-600">
                <p><strong>Phone:</strong> <a href="tel:+19727772665" className="text-electric-blue hover:underline">(972) 777-2665</a></p>
                <p><strong>Email:</strong> <a href="mailto:web@dfwhvac.com" className="text-electric-blue hover:underline">web@dfwhvac.com</a></p>
